...
namespace TcKimlikNoDogrulama
{
    public partial class Form1 : Form
    {
        ...
        private void sfBtnKontrol_Click(object sender, EventArgs e)
        {
            TCKimlikNoDogrulama.KPSPublic kps=new TCKimlikNoDogrulama.KPSPublic();
          bool kontrol=  kps.TCKimlikNoDogrula(long.Parse(txttcNo.Text),txtisim.Text.ToUpper(),txtsoyisim.Text.ToUpper(),int.Parse(txtdogumYil.Text));
            if (kontrol)
            {
